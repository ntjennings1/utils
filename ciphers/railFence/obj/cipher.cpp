 ...
 * 
 * The Railfence cipher is an encryption algorithm that uses
 ...
 * 
 * @return rails An integer representing the number of rails.
 */
int Cipher::getRails()
{
    return this->rails;
 ...
 * 
 * @param rails An integer representing the number of rails.
 */
...
/**
 * Adds initialized rows to the cipher table.
 * 
 * @return null
 */
void Cipher::addRows()
